#!/usr/bin/env python3
"""Generate Turbort compile compile option configs.

Usage: <path_to_turbort>/copts/generate_copts.py
...
def file_header_lines():
  return [
      ...
      "(1) Edit turbort/copts/copts.py.",
      "(2) Run `python <path_to_turbort>/copts/generate_copts.py`."
  ]
...
class CMakeStyle(object):
  ...
  def filename(self):
    return "GENERATED_TurbortCopts.cmake"
