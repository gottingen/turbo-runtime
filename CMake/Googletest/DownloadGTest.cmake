...
set(TURBORT_SAVE_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
set(TURBORT_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
set(CMAKE_CXX_FLAGS ${TURBORT_SAVE_CMAKE_CXX_FLAGS})
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${TURBORT_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
# targets.
add_subdirectory(${turbort_gtest_src_dir} ${turbort_gtest_build_dir} EXCLUDE_FROM_ALL)
